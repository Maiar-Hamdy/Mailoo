            ...
            modelBuilder.Entity("Mailo.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Sizes = 0,
                            AdditionDate = "12/1/2024 1:51:29 PM",
                            Category = 1,
                            Discount = 10m,
            ...
            modelBuilder.Entity("Mailo.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordResetToken = "ec56e0b8-6215-4894-9c33-e5dfac95d114",
                            PhoneNumber = "01011895030",
                            RegistrationDate = new DateTime(2024, 12, 1, 13, 51, 29, 691, DateTimeKind.Local).AddTicks(4771),
                            UserType = 1,
            ...
            modelBuilder.Entity("Mailo.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordResetToken = "7bd0f1f8-7518-496c-88e2-1fd360bdc3dd",
                            PhoneNumber = "01011890000",
                            RegistrationDate = new DateTime(2024, 12, 1, 13, 51, 29, 691, DateTimeKind.Local).AddTicks(5166),
                            UserType = 2,
                            Username = "AhmedAssemAdmin123",
                            HiringDate = new DateTime(2024, 12, 1, 13, 51, 29, 691, DateTimeKind.Local).AddTicks(5160)
                        });
                });
